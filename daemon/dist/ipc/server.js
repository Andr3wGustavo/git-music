...
class DaemonIPCServer {
    ...
    constructor(port, ledger, cas, projectRoot) {
        this.port = port;
        this.ledger = ledger;
        this.cas = cas;
        ...
        switch (msg.type) {
            ...
            case 'MERGE_PULL_REQUEST': {
                ...
                if (pr) {
                    ...
                    const mergePlan = mergeEngine_1.StemMergeEngine.analyzeMerge(sourceCommit, targetCommit);
                    mergeEngine_1.StemMergeEngine.executeMerge(this.ledger, mergePlan, pr.author);
...
exports.DaemonIPCServer = DaemonIPCServer;
